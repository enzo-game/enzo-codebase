            ...
            {game.eBoard.map((e) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="hs-stat hs-stat-sm hs-stat-atk">
                    <IconSword className="w-2.5 h-2.5 shrink-0" />
                    {e.attack}
                  </span>
                  <span className={`hs-stat hs-stat-sm hs-stat-hp ${e.health < e.maxHealth ? "text-rose-200" : ""}`}>
                    <IconHeart className="w-2.5 h-2.5 shrink-0" />
                    {e.health}
                  </span>
                </button>
              );
            ...
            {game.pHand.map((c, i) => {
              ...
              return (
                ...
                >
                  ...
                  {/* 法力水晶（實際費用） */}
                  <span className="hs-cost-gem">{c.cost}</span>
                  {/* 攻／血寶石（隨從）或類型小牌（法術） */}
                  {c.type === "minion" ? (
                    <>
                      <span className="hs-stat hs-stat-atk">
                        <IconSword className="w-3 h-3 shrink-0" />
                        {c.attack}
                      </span>
                      <span className="hs-stat hs-stat-hp">

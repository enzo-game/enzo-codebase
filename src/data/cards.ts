...
const BASE_CARDS: Card[] = [
  ...
  { id: "leg-l06", nameZh: "二日當空", type: "spell", cost: 5, rarity: "legendary", theme: "legend", vocabId: "11-02", effect: "twoSuns", effectText: "對敵方英雄造成 4 點傷害，所有隨從（雙方）受 1 點", bonusText: "我方隨從免疫這 1 點" },
  ...
  { id: "leg-l08", nameZh: "射日之箭", type: "spell", cost: 6, rarity: "legendary", theme: "legend", vocabId: "16-03", effect: "dmgAny8", effectText: "造成 8 點傷害（任一目標）", bonusText: "答對退 1 費" },
  { id: "leg-l09", nameZh: "大洪水", type: "spell", cost: 7, rarity: "legendary", theme: "legend", vocabId: "11-24", effect: "floodAll4", effectText: "對所有隨從（不分敵我）造成 4 點傷害", bonusText: "我方英雄回復 3" },
  ...
  { id: "leg-l17", nameZh: "沒入海的雙腳", type: "minion", cost: 6, attack: 4, health: 8, rarity: "legendary", theme: "legend", vocabId: "10-05", keywords: ["taunt"], effectText: "嘲諷", bonusText: "+0/+3", bonusStats: { atk: 0, hp: 3 } },
